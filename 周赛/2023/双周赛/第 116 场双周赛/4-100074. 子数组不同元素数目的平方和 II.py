...
# 题目链接：
# 竞赛：https://leetcode.cn/contest/biweekly-contest-116/problems/subarrays-distinct-element-sum-of-squares-ii/
# 题库：https://leetcode.cn/problems/subarrays-distinct-element-sum-of-squares-ii/description/
...
examples = [
    (dict(nums=[1, 2, 1]), 15),
    (dict(nums=[2, 2]), 3),
    (dict(nums=[5, 2, 4, 2, 1, 3, 2, 4, 3, 1]), 578),
    (dict(nums=[5, 2, 2, 2, 1, 2, 2, 2, 2, 1]), 193),
]
for e, a in examples:
    print(a, e)
    print(s.sumCounts(**e))
